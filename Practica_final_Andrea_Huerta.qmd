...
**Respuesta**: '' Boxplot. La l�nea del medio de la caja representa la mediana."
...
**Respuesta**: ''Porque el grupo de train (70-80% de los datos) se utilizar� para entrenar el modelo y que aprenda. El grupo de test (resto de datos) probar� la calidad del mismo, si predice bien o no. Para poder comprobar eso deben ser datos que no haya visto el modelo."
...
**Respuesta**: ''Un modelo de regresi�n log�stica."
...
**Respuesta**: ''Esas l�neas est�n extrayendo una tabla que compara el tipo real de semillas con los tres grupos o cluster realizados con la funci�n kmeans."
